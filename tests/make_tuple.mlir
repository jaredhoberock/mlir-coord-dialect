...
// CHECK: %[[C:.+]] = coord.make_tuple(%arg0 : i64) : tuple<i64>
...
// CHECK: %[[C:.+]] = coord.make_tuple : tuple<>
...
// CHECK: %[[C:.+]] = coord.make_tuple(%arg0 : tuple<i64>) : tuple<tuple<i64>>
func.func @make_single_of_single(%arg0: tuple<i64>) -> tuple<tuple<i64>> {
  %c = coord.make_tuple(%arg0 : tuple<i64>) : tuple<tuple<i64>>
...
// CHECK: %[[C:.+]] = coord.make_tuple(%arg0, %arg1 : i64, i64) : tuple<i64, i64>
func.func @make_pair_of_i64(%arg0: i64, %arg1: i64) -> tuple<i64,i64> {
  %c = coord.make_tuple(%arg0, %arg1 : i64, i64) : tuple<i64,i64>
...
// CHECK: %[[C:.+]] = coord.make_tuple(%arg0, %arg1 : i64, tuple<i64, i64>) : tuple<i64, tuple<i64, i64>>
func.func @make_nested(%arg0: i64, %arg1: tuple<i64,i64>) -> tuple<i64,tuple<i64,i64>> {
  %c = coord.make_tuple(%arg0, %arg1 : i64, tuple<i64,i64>) : tuple<i64,tuple<i64,i64>>
...
// CHECK: %[[C:.+]] = coord.make_tuple(%arg0, %arg1, %arg2 : i64, tuple<i64, i64>, i64) : tuple<i64, tuple<i64, i64>, i64>
func.func @make_nested_middle(%arg0: i64, %arg1: tuple<i64,i64>, %arg2: i64)
      -> tuple<i64,tuple<i64,i64>,i64> {
  %c = coord.make_tuple(%arg0, %arg1, %arg2 : i64, tuple<i64,i64>, i64)
        : tuple<i64,tuple<i64,i64>,i64>
...
// CHECK: %[[C:.+]] = coord.make_tuple(%arg0, %arg1 : tuple<i64, i64>, tuple<i64>) : tuple<tuple<i64, i64>, tuple<i64>>
func.func @make_deeply_nested(%arg0: tuple<i64,i64>, %arg1: tuple<i64>)
      -> tuple<tuple<i64,i64>,tuple<i64>> {
  %c = coord.make_tuple(%arg0, %arg1 : tuple<i64,i64>, tuple<i64>)
        : tuple<tuple<i64,i64>,tuple<i64>>
...
// CHECK: %[[C:.+]] = coord.make_tuple(%arg0, %arg1, %arg2 : tuple<>, i64, tuple<i64>) : tuple<tuple<>, i64, tuple<i64>>
func.func @make_mixed_tuple(
    %arg0: tuple<>,
    %arg1: i64,
    %arg2: tuple<i64>
) -> tuple<tuple<>,i64,tuple<i64>> {
  %c = coord.make_tuple(%arg0, %arg1, %arg2 : tuple<>, i64, tuple<i64>)
        : tuple<tuple<>,i64,tuple<i64>>
